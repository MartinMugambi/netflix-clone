...
const Details = () => {
  ...
  useEffect(() => {
    ...
    fetchMovie(
      `https://api.themoviedb.org/3/movie/${movieId}?api_key=5d657d365f93f31013f78d331be5420e&language=en-US&page=1&include_adult=false`
    )
      .then((response) => {
        setData(response);
      })
  ...
  return (
    <div>
      ...
      <div className="details__actor">{actorList}</div>
    </div>
  );
};
